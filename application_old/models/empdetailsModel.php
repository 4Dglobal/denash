<?php
 class empdetailsModel extends CI_Model
 {
  ...
  public function agentdata(){
    $user =$this->db->query("SELECT * FROM users WHERE role!='admin' and emp_id not in (SELECT Emp_id FROM emp_personal_details where Emp_id != '')");
    return $user->result();
  }
...
//print_r($data);
    ...
    $values = array(
            ...
            "MB_Softwares_Worked_On" =>  implode(",",$data['MBSoftwareon']),
            "MB_Specialties_Worked_On" =>  implode(",",$data['MBSpecial']),
