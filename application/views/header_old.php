  ...
  <div class="side-menu">
      ...
      <ul class="treeview menu">
        ...
        <li class="<?php if($actlinks == "home") echo "active";?>">
          <a class="<?php if($actlinks == "home") echo "active";?>" href="<?php echo base_url();?>home">
          <span><i class="far fa-envelope-open ic-w mx-1"></i>Dashboard</span></a>
        </li>
        <li class="<?php if($actlinks == "home") echo "active";?>">
          <i class="fas fa-angle-right rotate"></i> <span><i class="far fa-envelope-open ic-w mx-1"></i>Registration/Setup</span>
          <ul class="nested">
            <li>Client</li>
            <li>Department</li>
            <li>Agent</li>
	...
	<li class="<?php if($actlinks == "Employee_personal") echo "active";?>">
	<a class="<?php if($actlinks == "Employee_personal") echo "active";?>" href="<?php echo base_url();?>Employee_personal">Employee Information</a></li>
